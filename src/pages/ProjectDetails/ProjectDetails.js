...
const ProjectDetails = ({ match }) => {
  ...
  return (
    <section className="project-details container">
      <div
        style={{
          background: `url(${project.mainImg}) top no-repeat`,
      ...
      <div className="project-details__content">
        <div className="project-details__content-title">
          <h2 className="project-details__content-title-head">
            {project.name}
          </h2>
          <p className="project-details__content-title-text">
            {project.description}
          </p>
          <a
        ...
        <div className="project-details__content-background">
          <h3 className="project-details__content-background-head">
            Project Background
          </h3>
          <p className="project-details__content-background-text">
            {project.background}
          </p>
          ...
          <div className="project-details__content-background-previews">
            ...
            <div
              style={{
                background: `url(${project.staticPreview_1}) center no-repeat`,
                backgroundSize: "cover",
              }}
              className="static-preview-1"
            ></div>
            <div
              style={{
                background: `url(${project.staticPreview_2}) center no-repeat`,
                backgroundSize: "cover",
              }}
              className="static-preview-2"
            ></div>
          </div>
        </div>
      </div>
