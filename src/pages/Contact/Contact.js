    ...
    return (
        <div className='contact container'>
            <div className="contact__get-in-touch">
                <h2>Get in Touch</h2>
                <div className="contact__get-in-touch-content">
            ...
            <div className="contact__contact-me">
                <h2>Contact Me</h2>
                <div className="contact__contact-me-content">
                    <form>
