            ...
            <div className="projects__item">
                ...
                <div className="projects__item-content">
                    <div className="projects__item-content-container">
                        ...
                        <Link to='/projects/MyTeam'><button className="projects__item-content-btn btn">View Project</button></Link>
                    </div>
            ...
            <div className="projects__item">
                ...
                <div className="projects__item-content">
                    <div className="projects__item-content-container">
                        ...
                        <Link to='/projects/Photosnap'><button className="projects__item-content-btn btn">View Project</button></Link>
                    </div>
                    <div className="border-top"></div>
                    <div className="border-bottom"></div>
                </div>
            ...
            <div className="projects__item">
                ...
                <div className="projects__item-content">
                    <div className="projects__item-content-container">
                        ...
                        mobile navigation.</p>
                        <Link to='/projects/Beach Resort'><button className="projects__item-content-btn btn">View Project</button></Link>
                    </div>
                    <div className="border-top"></div>
                    <div className="border-bottom"></div>
                </div>
